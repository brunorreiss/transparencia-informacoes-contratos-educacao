...
logger_name = env.get('BOT_NAME', default='transparencia-informacoes-contratos-educacao')
...
tags_metadata = [
    {
        'name': 'transparencia-informacoes-contratos-educacao',
        'description': 'Consulta Portal Tranparencia Fortaleza - informacoes contratos educação'
    }
]
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Consulta Portal Tranparencia Fortaleza - Informações de contratos educação', 
    description=desc, 
    debug=False, 
